// BUDGET CONTROLLER: handling data and data structures
var budgetController = (function(){
    ...
    return {
        addItem: function(type, des, val){
            ...
            // Push it into our data structure(array)
            data.allItems[type].push(newItem); // type: 'exp' or 'inc'两种
...
var UIController = (function(){
    // Private object.
    // Store all the classes in a object for easy reference
    var DOMstrings = {
        inputType: '.add__type',
    ...
    var formatNumber = function(num, type){
        ...
        // 1. + or - before number
        num = Math.abs(num);
        // 2. Exactly 2 decimal points, use the method of the number prototype
        num = num.toFixed(2); // num now is a string 
    ...
    return {
        getInput: function(){
            return {
                ...
                value : parseFloat(document.querySelector(DOMstrings.inputValue).value) // turn string to number
            };
        },
...
// GLOBAL APP CONTROLLER: to connect UIController and budgetController together
var controller = (function(budgetCtrl, UICtrl){
    var setupEventListeners = function(){
        ...
        // Change the color of input field according to input type
    ...
    var ctrlAddItem = function(){
        ...
        // Input description should not be an empty stirng, and input value should be a number > 0
    ...
    return {
        // init function: where the application starts
        init: function(){
...
controller.init(); // Where the application actually starts. 
